...
<div class="ajax">
	...
	<?php if (TMM::get_option('folio_tpl_show_folios_bar')): ?>
		<?php $folios = TMM::get_option('folio_template1_items'); ?>
		<?php if (!empty($folios)): ?>
			<ul class="scroll-box-nav" id="folio_categories_bar">
				<?php foreach ($folios as $post_id) : ?>
					...
					?>
					<li><a href="#" data-post-id="<?php echo $post_id ?>" data-layout="1"><?php echo get_post_field('post_title', $post_id) ?></a></li>
				<?php endforeach; ?>
			</ul><!--/ .scroll-box-nav-->
		<?php endif; ?>
	<?php endif; ?>
	...
	<div id="folio_images_area">
		<?php TMM_Portfolio::draw_home_layout(1,$folio_post_id); ?>
	</div>
